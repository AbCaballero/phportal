...
(function($) {
  Drupal.behaviors.post_autosave = {
    attach : function(context, settings) {
      ...
      //replaces $checkNotApplicableRes1
      $checkNotApplicableFel();
      //replaces $checkNotApplicableRes2
      ...
      $('#edit-residency-na', context).change(function() {
        $checkNotApplicableRes();
      });

      $('#edit-fellowship-na', context).change(function() {
        $checkNotApplicableFel();
      });
    ...
    /*  $('#edit-deareg-0-all', context).change(function() {
        $checkSelectAll();
      });*/
